 ...
 * @author benra
 */
public class Document_Creation_Coach {

    public void generatePDF() throws IOException, SQLException {
        PDDocument doc = new PDDocument();

        MembreServices ar = new MembreServices();
        ArrayList<Membre> articles = new ArrayList<>();

        // ArrayList<Article> list=articles.toArray();
        articles = (ArrayList<Membre>) ar.afficherPDF();
        ...
        PDImageXObject pdImage = PDImageXObject.createFromFile("/Users/mohamedbouslah/Desktop/PiDev/DesktopFx/src/edu/maindspace/css/Logo.png", doc);
        ...
        contentStream.showText("Our Menu");
        contentStream.endText();
        ...
        doc.save("Liste_Membre.pdf");
        doc.close();
        System.out.println("pdf saved");

    }

    public static void drawTable(PDPage page, PDPageContentStream contentStream, float y, float margin, ArrayList<Membre> articles)
            throws IOException {
        ...
        String[] list = {"Cin", "Nom", "Prenom", "Sexe", "Date", "Telephone"};
        ...
        contentStream.setFont(PDType1Font.HELVETICA_BOLD, 8);
        contentStream.setNonStrokingColor(Color.black);
        for (Membre cons : articles) {

//            String text;
//            if (cons.getNom().length() > 14) {
//                text = cons.getNom().substring(0, 13) + "..";
//            } else {
//                text = cons.getNom();
//            }
//
...
//            textx += colWidth;
            //////////////////////
            String text7 = "" + cons.getTelephone();
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
