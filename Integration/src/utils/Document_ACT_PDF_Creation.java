 ...
 * @author DELL
 */
public class Document_ACT_PDF_Creation {
  public void generatePDF() throws IOException, SQLException {
        PDDocument doc = new PDDocument();
        
        ActiviteService ar = new ActiviteService();
        ArrayList<Activite> articles = new ArrayList<>();

        // ArrayList<Article> list=articles.toArray();
        articles = (ArrayList<Activite>) ar.ActiviteListe();
       ...
       contentStream.drawXObject(pdImage, 50, 605, 140, 140);
        ...
        contentStream.showText("Toutes nos activités");
        contentStream.endText();
    ...
    public static void drawTable(PDPage page, PDPageContentStream contentStream, float y, float margin, ArrayList<Activite> articles)
            throws IOException {
        ...
        String[] list = {"Nom activité", "Catégorie","Description", "Prix", "Centre"};
        ...
        contentStream.setFont(PDType1Font.HELVETICA_BOLD, 8);
        contentStream.setNonStrokingColor(Color.black);
        for (Activite cons : articles) {

               //////////////////////
            String text = "" + cons.getNom_act(); 
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
            ...
            textx += colWidth;
            //////////////////////
            String text2 = "" + cons.getCategorie_act();
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
            ...
            String text3;
            if (cons.getDescription().length() > 14) {
                text3 = cons.getDescription().substring(0, 13) + "..";
            } else {
                text3 = cons.getDescription();
            }
            ...
            String text4 = "" + cons.getPrix_reservation();
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
            ...
            String text5 = "" + as.getCentre(cons.getId_centre()).getNom_centre();
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
