 ...
 * @author benra
 */
public class Document_Creation_Menu {
    
    public void generatePDF() throws IOException, SQLException {
        PDDocument doc = new PDDocument();
        
        ServiceMenu ar = new ServiceMenu();
        ArrayList<Menu> articles = new ArrayList<>();

        // ArrayList<Article> list=articles.toArray();
        articles = (ArrayList<Menu>) ar.afficherPDF();
        ...
        doc.save("my_doc_menu.pdf");
        doc.close();
        System.out.println("pdf saved");

    }

    public static void drawTable(PDPage page, PDPageContentStream contentStream, float y, float margin, ArrayList<Menu> articles)
            throws IOException {
        ...
        String[] list = {"Jour Numero", "Description", "Matin", "Dejeuner", "Dinner", "Total Calories"};
        ...
        contentStream.setFont(PDType1Font.HELVETICA_BOLD, 8);
        contentStream.setNonStrokingColor(Color.black);
        for (Menu cons : articles) {

            String text = "" + cons.getNum_jour();;
//            if (cons.getDescirption().length() > 14) {
//                text = cons.getDescirption().substring(0, 13) + "..";
//            } else {
//                text = cons.getDescirption();
//            }
//
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
            ...
            textx += colWidth;
            //////////////////////
            String text2 = "" + cons.getDescirption();
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
            ...
            textx += colWidth;
            //////////////////////
            String text6 = "" + cons.getTotal_calories()+ " Calories";
            contentStream.beginText();
            contentStream.moveTextPositionByAmount(textx, texty);
